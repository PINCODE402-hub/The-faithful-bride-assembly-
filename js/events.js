...
if (eventsGrid) {
    ...
    onSnapshot(eventsQuery, (snapshot) => {
        ...
        // Inside your onSnapshot loop in events.js
        snapshot.forEach((docSnapshot) => {
            ...
            if (event.date >= today) {
                ...
                // Use document.body.classList check instead of sessionStorage
                ...
                card.innerHTML = `
                    ...
                    ${isAdmin ? `<button class="delete-event-btn" data-id="${docSnapshot.id}">Delete Event</button>` : ''}
                `;
